...
export default function Services() {
  return (
    ...
    //   </div>
    // </div>
    <div className="flex justify-betweeen gap-x-20 items-center w-full max-w-[1380px] mx-auto my-44 mb-20 px-3 max-xl:flex-col gap-y-5">
      <div className="bg-[#f8f8f8] w-full max-w-[300px] p-[50px] max-xl:max-w-full">
      ...
      <ul className="flex flex-row flex-wrap justify-between gap-y-10 text-center">
        <li className="flex justify-center flex-col items-center bg-[#f8f8f8] py-10 px-5 gap-y-2" style={{width: "calc(33.3333% - 20px)"}}>
